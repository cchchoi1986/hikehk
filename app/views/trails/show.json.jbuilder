...
json.start_longitude @trail.start_longitude
json.start_latitude @trail.start_latitude
json.end_longitude @trail.end_longitude
json.end_latitude @trail.end_latitude
json.region_id @trail.region_id
json.birds @trail.region.birds
json.plants @trail.region.plants
